...
_PATTERN_REFS: dict[str, tuple[str, str]] = {
    ...
    "dead letter": (
        ...
        "Microsoft: Queue-Based Load Leveling",
    ),
    "throttling": (
        "https://learn.microsoft.com/azure/architecture/patterns/throttling",
        "Microsoft: Throttling Pattern",
    ),
    "claim check": (
        "https://learn.microsoft.com/azure/architecture/patterns/claim-check",
        "Microsoft: Claim Check Pattern",
    ),
    "competing consumers": (
        "https://learn.microsoft.com/azure/architecture/patterns/competing-consumers",
        "Microsoft: Competing Consumers",
    ),
    "priority queue": (
        "https://learn.microsoft.com/azure/architecture/patterns/priority-queue",
        "Microsoft: Priority Queue Pattern",
    ),
    "sharding": (
        "https://learn.microsoft.com/azure/architecture/patterns/sharding",
    ...
    "information expert": (
        ...
        "Wikipedia: GRASP Information Expert",
    ),
    ...
    "pure fabrication": (
        ...
        "Wikipedia: GRASP Pure Fabrication",
    ),
    "indirection": (
        "https://en.wikipedia.org/wiki/GRASP_(object-oriented_design)#Indirection",
        "Wikipedia: GRASP Indirection",
    ),
    ...
    "skeleton screen": (
        ...
        "UX Collective: Skeleton Screens",
    ),
    ...
    "three pillars": (
        ...
        "O'Reilly: Distributed Systems Observability",
    ),
    ...
    "immutable infrastructure": (
        ...
        "Wikipedia: Immutable Infrastructure",
    ),
    # Security
    "zero trust": (
    ...
    "service discovery": (
        ...
        "Microservices.io: Service Registry",
    ),
    "distributed tracing": (
    ...
    "specification pattern": (
        ...
        "Wikipedia: Specification Pattern",
    ),
    ...
    "gestalt": (
        ...
        "Wikipedia: Gestalt Laws",
    ),
    "proximity": (
        "https://en.wikipedia.org/wiki/Gestalt_psychology#Proximity",
        "Wikipedia: Gestalt Proximity",
    ),
    "similarity": (
        "https://en.wikipedia.org/wiki/Gestalt_psychology#Similarity",
        "Wikipedia: Gestalt Similarity",
    ),
    "closure": (
        "https://en.wikipedia.org/wiki/Gestalt_psychology#Closure",
        "Wikipedia: Gestalt Closure",
    ),
    ...
    "modal": (
        ...
        "Nielsen Norman: Modal Dialog",
    ),
    "toast": (
        "https://www.nngroup.com/articles/indicators-validations-notifications/",
        "Nielsen Norman: Notifications",
    ),
    "form validation": (
        "https://www.nngroup.com/articles/errors-forms-design-guidelines/",
        "Nielsen Norman: Form Errors",
    ),
    "error message": (
        "https://www.nngroup.com/articles/error-message-guidelines/",
        "Nielsen Norman: Error Messages",
    ),
    "loading indicator": (
    ...
    "empty state": (
        ...
        "Nielsen Norman: Empty States",
    ),
    "infinite scroll": (
        "https://www.nngroup.com/articles/infinite-scrolling-tips/",
        "Nielsen Norman: Infinite Scroll",
    ),
    ...
    "guard clause": (
        ...
        "Refactoring Guru: Guard Clauses",
    ),
    "early return": (
        "https://refactoring.guru/replace-nested-conditional-with-guard-clauses",
        "Refactoring Guru: Guard Clauses",
    ...
    "miller's law": (
        ...
        "Wikipedia: Miller's Law",
    ),
    # UX patterns
    "command palette": (
        "https://www.nngroup.com/articles/command-palette/",
        "NN/g: Command Palette",
    ),
    ...
    "fail fast": (
        "https://en.wikipedia.org/wiki/Fail-fast_(systems_design)",
        "Wikipedia: Fail-Fast",
    ),
    ...
    "measure before optim": (
        "https://wiki.c2.com/?PrematureOptimization",
        "C2 Wiki: Premature Optimization",
    ),
    "deterministic test": (
        "https://martinfowler.com/articles/nonDeterminism.html",
        "Martin Fowler: Non-Determinism in Tests",
    ),
    "input validation": (
        "https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html",
        "OWASP: Input Validation",
    ...
    "red/yellow/green": (
        ...
        "Wikipedia: Traffic Light Rating",
    ),
    # RAG patterns
    "chunk overlap": (
    ...
    "grounded generation": (
        "https://docs.cohere.com/docs/grounded-generation",
    ...
    "phased delivery": (
        ...
        "Wikipedia: Iterative Development",
    ),
    # Cloud / multi-cloud
    "landing zone": (
        "https://learn.microsoft.com/azure/cloud-adoption-framework/ready/landing-zone/",
        "Microsoft: Landing Zones",
    ),
    ...
    # Systems / scaling
    "horizontal scaling": (
        "https://en.wikipedia.org/wiki/Scalability#Horizontal_(scale_out)",
        "Wikipedia: Horizontal Scaling",
    ),
    "read replica": (
        "https://en.wikipedia.org/wiki/Replication_(computing)",
        "Wikipedia: Replication",
